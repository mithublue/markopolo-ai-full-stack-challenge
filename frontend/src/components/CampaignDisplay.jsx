...
const CampaignDisplay = ({ content, isStreaming, completeData }) => {
  ...
  return (
    <div className="flex-1 bg-white border border-primary-200 rounded-lg shadow-lg overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 p-4 text-white">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-primary-100 text-sm mt-1">Campaign ID: {campaign.id}</p>
          </div>
          <button
            onClick={handleCopy}
      ...
      <div className="grid grid-cols-3 gap-4 p-4 bg-gray-50 border-b border-gray-200">
        ...
        <div>
          <p className="text-xs text-gray-600">ROI Projection</p>
          <p className="text-lg font-bold text-green-600">{budget.roi_projection}</p>
        </div>
      </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-primary-50 border border-primary-200 rounded-lg p-4">
          <h4 className="font-semibold text-gray-900 mb-2 flex items-center gap-2">
            🎯 Recommended Channel: <span className="text-primary-700">{channel.name}</span>
          </h4>
          <p className="text-sm text-gray-700">{channel.reasoning}</p>
        ...
        <div className="border border-gray-200 rounded-lg p-4">
          ...
          <p className="text-sm text-gray-700 bg-gray-50 p-3 rounded">{message.primary}</p>
        </div>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <h4 className="font-semibold text-gray-900 mb-2">💰 Budget Estimate</h4>
